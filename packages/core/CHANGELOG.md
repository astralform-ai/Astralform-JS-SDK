...
Requires Astralform >= 0.70.0 for every field above; against an older backend they are simply absent (`mode`, `repository`) or 404 (`code.projects.*`).
